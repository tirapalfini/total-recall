<?php
	...
	else
	{
		...
		/***************************************************************************************************************************
		* Same query as addProduct.php so the page doesn't error
		* Need query to update table with new values from editProductModal where name = the current name in same row as edit button
		****************************************************************************************************************************/
